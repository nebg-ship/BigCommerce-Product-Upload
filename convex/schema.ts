...
export default defineSchema({
  ...
  csv_import_runs: defineTable({
    ...
    changed_row_count: v.optional(v.number()),
    unchanged_row_count: v.optional(v.number()),
    sync_jobs_created_count: v.optional(v.number()),
    product_jobs_created_count: v.optional(v.number()),
    variant_jobs_created_count: v.optional(v.number()),
